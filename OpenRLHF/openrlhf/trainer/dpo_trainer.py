    ...
    def __init__(
        ...
        if self.strategy.args.use_wandb and self.strategy.is_rank_0():
            ...
            wandb.init(
                ...
                reinit=True,
                dir = '/mnt/bn/aml-us-mm/zhihan/wandb/'
            )
        ...
        for epoch in range(self.epochs):
            ...
            for data in self.train_dataloader:
                ...
                if not self.nll_loss:
                    nll_loss_mark  = nll_loss.detach().item()
                    nll_loss = 0
                ...
                logs_dict = {
                    ...
                    "logp_chosen": chosen_logps.detach().mean().item(),
                    "logp_rejected": rejected_logps.detach().mean().item(),
                    "loss_mean": loss_mean,
                    "acc_mean": acc_mean,
                }
                if self.nll_loss:
                    ...
                    logs_dict["nll_loss"] = nll_loss_mark

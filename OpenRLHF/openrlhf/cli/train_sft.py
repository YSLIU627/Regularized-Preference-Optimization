...
def train(args):
    ...
    # configure tokenizer
    tokenizer = get_tokenizer(args.pretrain, model.model, "right", strategy, use_fast=not args.disable_fast_tokenizer, write_chatml_template = args.write_chatml_template)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--write_chatml_template", type=str, default=None, help='write the chat template in chatml format and write it to tokenizer')
